...
def create_dataset_by_GAN(scenario, train_IDs, labels, num,data_path):
    ...
    new_IDs = []
    while num_flag > 0 or max_loop_num > 0:
    ...
    print("create dataset num: " + create_num)

    new_train_IDs = np.array(new_IDs)
    train_IDs_new = np.vstack((train_IDs,new_train_IDs))
    labels_new = labels
...
creating_size = 0.6                       # 60% create dataset by Using GAN
