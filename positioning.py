...
def create_dataset_by_GAN(scenario, train_IDs, labels,data_path):
...
for scenario in scenarios:
    ...
    for num_antenna in num_antennas:
        ...
        train_IDs_new, labels_new, data_path_new = create_dataset_by_GAN(scenario, train_IDs, labels,data_path=data_path)
